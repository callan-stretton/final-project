  ...
  return knex('videos').del()
    .then(() => {
      return knex('videos').insert([
        {id: 1, vid_url: 'gId6nrMDmUU', quote: 'I love lamp', startTime: 0, quoteStart: 13, quoteEnd: 16, pauseTime: 10, title: 'Anchorman'},
        ...
        {id: 4, vid_url: 'luBk4VrMHNI', quote: 'become a pop star and they give you them for free', startTime: 12, quoteStart: 21, quoteEnd: 25, pauseTime: 10, title: 'Love Actually'},
