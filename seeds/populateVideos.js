  ...
  return knex('videos').del()
    .then(() => {
      return knex('videos').insert([
        ...
        {id: 5, vid_url: '1YGfrGKK9Mo', quote: 'I\'m flying Jack', startTime: 25, quoteStart: 40, quoteEnd: 43, pauseTime: 10, title: 'Titanic'},
        {id: 6, vid_url: 'TU7CDejp6Lw', quote: 'Get to the chopper', startTime: 109, quoteStart: 130, quoteEnd: 132, pauseTime: 10, title: 'Predator'},
        ...
        {id: 10, vid_url: 'EemLsTG5fX8', quote: 'I wrote to you everyday for a year', startTime: 91, quoteStart: 102, quoteEnd: 104, pauseTime: 10, title: 'The Notebook'},
        {id: 11, vid_url: 'NVPLqbWXdDA', quote: 'leeloo dallas multipass', startTime: 51, quoteStart: 59, quoteEnd: 62, pauseTime: 10, title: 'The 5th Element'},
        {id: 12, vid_url: 'RKysEIVJfBs', quote: 'the names bond james bond', startTime: 67, quoteStart: 81, quoteEnd: 85, pauseTime: 10, title: 'Casino Royale'},
        {id: 13, vid_url: 'AyrP-pwDayE', quote: 'you had me at hello', startTime: 79, quoteStart: 90, quoteEnd: 93, pauseTime: 10, title: 'Jerry Maguire'},
